                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12 m-b-30">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <form id="form-multiple" class="section-to-print" enctype="multipart/form-data" method="post" target="<?= base_url('buatabsen_controller/PengajuanCreate/').$this->uri->segment('3'); ?>">
